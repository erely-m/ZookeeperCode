...
public interface SnapShot {
     ...
     * @throws IOException
     */
    long deserialize(DataTree dt, Map<Long, Integer> sessions)  //反序列化，将快照反序列化为DataTree
        throws IOException;
     ...
     * @throws IOException
     */
    File findMostRecentSnapshot() throws IOException;//找到最近的一个快照
