...
public class QuorumPeerConfig {
    ...
    public void parse(String path) throws ConfigException {
        ...
        try {
            ...
            parseProperties(cfg); //从属性文件中解析对应配置
        } catch (IOException e) {
    ...
    throws IOException, ConfigException {
        ...
        for (Entry<Object, Object> entry : zkProp.entrySet()) {
            ...
            if (key.equals("dataDir")) { //数据目录
                ...
                if (value.toLowerCase().equals("observer")) { //观察者模式，类似fllower但不参与投票选举，降低集群之间选举时间
            ...
            } else if (key.equals("autopurge.snapRetainCount")) { //快照数量
                snapRetainCount = Integer.parseInt(value);
            } else if (key.equals("autopurge.purgeInterval")) {//快照保存时间
