...
public class StatPersisted implements Record {
  private long czxid; //创建的zxid
  private long mzxid; //修改的zxid
  private long ctime;  //创建时间
  private long mtime;  //修改时间
  private int version; //版本号
  private int cversion; //子节点变化版本
  private int aversion; //acl权限列表控制版本
  private long ephemeralOwner; //如果是临时节点该值为拥有这的sessionId 如果不是临时节点则为0
  private long pzxid; //该节点的子节点最后一次被更新的zxid 与孙子节点无关
