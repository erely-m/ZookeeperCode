...
public class ZooDefs {
    ...
    public interface Perms { //节点权限
        ...
        int ADMIN = 1 << 4; //对本节点setACL权限

        int ALL = READ | WRITE | CREATE | DELETE | ADMIN; //所有权限
    }
    ...
    public interface Ids {
         ...
         */
        public final Id ANYONE_ID_UNSAFE = new Id("world", "anyone"); //schema  world 固定用户对所有用户开放所有权限

        /**
         * This Id is only usable to set ACLs. It will get substituted with the
         * Id's the client authenticated with.
         */
        public final Id AUTH_IDS = new Id("auth", ""); // schema auth  不使用任何Id，证明任何已确认用户
