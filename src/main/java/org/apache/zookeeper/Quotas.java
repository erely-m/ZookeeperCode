...
public class Quotas { //配额类
     ...
     * a subtree
     */
    public static final String limitNode = "zookeeper_limits";//node限制path的结尾后缀

    /**
     * the stat node that monitors the limit of
     * a subtree.
     */
    public static final String statNode = "zookeeper_stats";//node实际状态path的结尾后缀
     ...
     */
    public static String quotaPath(String path) { //zk某个节点转换成配额的path
     ...
     */
    public static String statPath(String path) {//节点状态的path
        return quotaZookeeper + path + "/" +
        statNode;
    }
}
